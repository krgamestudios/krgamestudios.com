			...
			<BrowserRouter>
				...
				<div className='central'>
					<Switch>
						...
						<Route exact path='/keepitalive' render={()=><div className='page'><Unity className='panel' unityContext={new UnityContext('unity/KeepItAlive/Build/KeepItAlive.json', 'unity/KeepItAlive/Build/UnityLoader.js')} /></div>} />
